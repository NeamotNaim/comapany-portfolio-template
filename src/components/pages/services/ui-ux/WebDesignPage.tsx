...
const WebDesignPage: React.FC = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mb-6 inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">Web Design & Development</span>
            </div>
            
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
              <span className="block">Responsive & Modern</span>
            ...
            <p className="mt-6 max-w-3xl mx-auto text-xl text-gray-300 leading-relaxed">
              Create stunning, responsive websites with pixel-perfect designs and seamless user experiences from concept to launch, including CMS integration and SEO optimization.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              ...
              >
                <span className="relative z-10">Get Web Design Quote</span>
              </Link>
              <Link
                to="/case-studies"
                className="group relative overflow-hidden rounded-xl border-2 border-white/20 bg-white/10 px-8 py-4 text-center text-lg font-medium text-white backdrop-blur-sm transition-all hover:scale-105 hover:bg-white/20"
              >
                <span className="relative z-10">View Web Examples</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* What is Web Design & Development Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Web Design & Development combines beautiful visual design with robust technical implementation. Our solutions deliver responsive, fast-loading websites that provide exceptional user experiences across all devices and browsers.
              </p>
              <div className="space-y-4">
                {[
                  'Responsive design for all screen sizes and devices',
                  'Modern frontend development with latest technologies',
            ...
            <div className="relative">
              <img
                ...
                alt="Web Design & Development Process"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Modern web technologies and frameworks for building fast, scalable, and maintainable websites
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { name: 'WordPress', icon: '📝', desc: 'Content management system' },
              { name: 'Shopify', icon: '🛒', desc: 'E-commerce platform' },
              { name: 'Figma', icon: '🎯', desc: 'Design collaboration' },
              { name: 'Webflow', icon: '🌊', desc: 'Visual web development' }
            ].map((tech, index) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive web solutions for different business needs and industries
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Professional business websites with modern design and CMS integration',
                image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=400&h=300&fit=crop',
                features: ['Professional Design', 'CMS Integration', 'SEO Optimization', 'Contact Forms']
              },
              {
              ...
              },
              {
                ...
                features: ['Conversion Optimization', 'A/B Testing', 'Analytics Integration', 'Lead Capture']
              }
            ].map((service, index) => (
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Choose the package that fits your web design and development requirements
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-teal-900 to-cyan-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-extrabold mb-4">Ready to Build Your Website?</h2>
          <p className="text-xl text-teal-200 mb-8 max-w-2xl mx-auto">
            Create a stunning, responsive website that delivers exceptional user experiences and drives business growth.
          </p>
          <Link
            to="/contact"

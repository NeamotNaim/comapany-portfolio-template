    ...
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mb-6 inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">Network Security Solutions</span>
            </div>
            
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
              <span className="block">Robust & Comprehensive</span>
            ...
            <p className="mt-6 max-w-3xl mx-auto text-xl text-gray-300 leading-relaxed">
              Protect your network infrastructure with comprehensive security solutions that defend against threats, monitor traffic, and ensure secure connectivity across your organization.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              ...
              >
                <span className="relative z-10">Get Network Security</span>
              </Link>
              <Link
                to="/case-studies"
                className="group relative overflow-hidden rounded-xl border-2 border-white/20 bg-white/10 px-8 py-4 text-center text-lg font-medium text-white backdrop-blur-sm transition-all hover:scale-105 hover:bg-white/20"
              >
                <span className="relative z-10">View Security Cases</span>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Network Security protects your organization's network infrastructure from cyber threats and unauthorized access. Our comprehensive solutions provide multi-layered defense, real-time monitoring, and proactive threat detection.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive security layers to protect your network infrastructure
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: 'Firewalls', icon: '🔥', desc: 'Network traffic filtering' },
              { name: 'IDS/IPS', icon: '🛡️', desc: 'Intrusion detection & prevention' },
              { name: 'VPN Solutions', icon: '🔒', desc: 'Secure remote access' },
              { name: 'Network Monitoring', icon: '👁️', desc: 'Real-time traffic analysis' },
              { name: 'Access Control', icon: '🚪', desc: 'User & device authentication' },
              { name: 'SIEM Integration', icon: '📊', desc: 'Security event management' },
              { name: 'DDoS Protection', icon: '🛡️', desc: 'Attack mitigation' },
              { name: 'Network Segmentation', icon: '🏗️', desc: 'Isolated network zones' }
            ].map((component, index) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Multi-layered security approach for comprehensive network protection
            </p>
          </div>
            ...
            {[
              {
                ...
                features: ['Next-Gen Firewalls', 'Web Application Firewalls', 'DDoS Protection', 'Email Security']
              },
              {
                title: 'Internal Security',
                description: 'Protection and monitoring within the network infrastructure',
                image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&h=300&fit=crop',
                features: ['Network Segmentation', 'Access Controls', 'IDS/IPS Systems', 'Endpoint Protection']
              },
              {
                title: 'Monitoring & Response',
                description: 'Continuous monitoring and incident response capabilities',
                image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&h=300&fit=crop',
                features: ['SIEM Integration', 'SOC Monitoring', 'Threat Intelligence', 'Incident Response']
              }
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Choose the network security package that fits your infrastructure protection needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                name: 'Essential Network Security',
                price: '$18,000',
                timeline: '1-2 months',
                features: [
      ...
      <section className="py-24 bg-gradient-to-r from-orange-900 to-red-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-extrabold mb-4">Ready to Secure Your Network?</h2>
          <p className="text-xl text-orange-200 mb-8 max-w-2xl mx-auto">
            Protect your network infrastructure with comprehensive security solutions and 24/7 monitoring.
          </p>
          <Link
            to="/contact"
